...
# This repo has none; the constant exists so the three sibling repos'
# checkers stay structurally identical.
...
# JobDef/RecipeDef/ResearchProjectDef with no vanilla parents or translatable
# comp defaults), so the manifest is empty. The guards in
